...
class TestContourMerge(TestCase):
    ...
    def test_contorsRectangularity_(self):
    ...
    def test_appendContours_2(self):
        ...
        expected_result = np.array([[[2, 2]], [[1, 1]], [[0, 0]], [[3, 3]],
                                    [[4, 4]], [[5, 5]]])
    ...
    def test_appendContours_3(self):
        ...
        expected_result = np.array([[[0, 0]], [[1, 1]], [[2, 2]], [[5, 5]],
                                    [[4, 4]], [[3, 3]]])
    ...
    def test_appendContours_4(self):
        ...
        expected_result = np.array([[[2, 2]], [[1, 1]], [[0, 0]], [[5, 5]],
                                    [[4, 4]], [[3, 3]]])
    ...
    def test_mergeContours(self):
        ...
        expected_result = np.array([[[0, 0]], [[75, 3]], [[150, 0]],
                                    [[149, 303]], [[0, 300]], [[2, 160]],
                                    [[-2, 298]]])
    ...
    def test_contoursMergeable_1(self):
        ...
        self.assertTrue(cm.contoursMergeable(contour1, contour2,
                                             merged_contours))
...
class TestVectorMath(TestCase):
    ...
    def test_unit_vector(self):
        ...
        expected_result = [3.0/math.sqrt(27), 3.0/math.sqrt(27),
                           3.0/math.sqrt(27)]
